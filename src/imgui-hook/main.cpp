...
void draw()
{
	...
	if (show)
	{
		...
		ImGui::Begin("T7 - Debug viewer", &show);

		ImGui::BeginTabBar("##main");

		if (ImGui::BeginTabItem("Scripts")) {

			ImGui::BeginChild("Scr##Scr", ImGui::GetContentRegionAvail());
...
HRESULT __stdcall hkPresent(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
{
	...
	ImGui::NewFrame();
	ImGui::SetNextWindowSize(ImVec2(500, 300.0f), ImGuiCond_Once);
