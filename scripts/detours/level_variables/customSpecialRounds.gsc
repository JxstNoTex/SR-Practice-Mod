...
function factory_next_dog_round(){
    ...
    switch(level.players.size){
        ...
        case 2:
            ...
            //dog_rounds = [5, 9, 13, 17, 21, 25, 29, 33, 37, 41, 45, 49, 53, 57, 61, 65, 69, 74, 79, 83, 87, 91, 95, 99, 104, 109, 114, 118, 122, 126, 130, 134, 138, 142, 146, 150, 154, 158, 162, 166, 170, 174, 178, 182, 186, 190, 194, 198, 202, 206, 210, 214, 218, 222, 226, 230, 234, 238, 242, 246, 250, 254];
        break;
